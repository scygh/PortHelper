...
import com.moredian.entrance.porthelper.ToastHelper;
...
public class SerialPortUtils {
    ...
    public SerialPort openSerialPort(String path,int baudrate){
        try {
            ...
            ToastHelper.showToast("打开串口异常");
            return serialPort;
        }
        Log.d(TAG, "openSerialPort: 打开串口成功");
        ToastHelper.showToast("打开串口成功");
        return serialPort;
    }
    ...
    public void closeSerialPort(){
        try {
            ...
            ToastHelper.showToast("关闭串口异常");
            return;
        }
        Log.d(TAG, "closeSerialPort: 关闭串口成功");
        ToastHelper.showToast("关闭串口成功");
    }
    ...
    public void sendSerialPort(String data){
        ...
        try {
            ...
            if (sendData.length > 0) {
                ...
                ToastHelper.showToast("串口数据发送成功");
            }
        } catch (IOException e) {
            Log.e(TAG, "sendSerialPort: 串口数据发送失败："+e.toString());
            ToastHelper.showToast("串口数据发送失败");
        }
